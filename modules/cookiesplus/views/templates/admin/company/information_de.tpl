                    ...
                    <div class="row util-links">
                        <div class="col-lg-12">
                            <p>
                                ...
                                <i class="icon-external-link"></i> <a target="_blank" title="Dokumentation" href="{$this_path|escape:'htmlall':'UTF-8'}readme_de.pdf">Dokumentation</a><br/><br/>
                                        ...
                                        <a target="_blank" href="https://addons.prestashop.com/de/{$modules[$counter|escape:'htmlall':'UTF-8']['id']|escape:'htmlall':'UTF-8'}-.html" title="{$modules[$counter|escape:'htmlall':'UTF-8']['name']|escape:'htmlall':'UTF-8'}">
                                            ...
                                            <div class="module-footer">
                                                <div class="module-hover text-center">
                                                    <p class="btn btn-xsmall btn-plain btn-secondary">Entdecken</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
