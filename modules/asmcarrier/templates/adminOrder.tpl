        ...
        <div class="panel">
            ...
            <form id="asm_bultos" name="asm_bultos" title="" action="index.php" method="get" class="form-horizontal well hidden-print">
                <div class="form-group">
					<label class="control-label col-lg-1" for="asm_retorno">Retorno</label>
					<div class="col-lg-11">
                        <div class="col-lg-2">
                    		<select id="asm_retorno" name="asm_retorno" title="Retorno" alt="Retorno" class="form-control" data-toggle="tooltip" data-placement="top">
								<option value="0">Sin retorno</option>
								<option value="1">Retorno obligatorio</option>
								<option value="2">Retorno opcional</option>
							</select>
						</div>
					</div>
                </div>
