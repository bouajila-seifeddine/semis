...
{   
    ...
    public function uninstall()
    {
        ...
        **/
        Configuration::deleteByName('PH_BLOG_MASONRY_LAYOUT');
        ...
        **/
        Configuration::deleteByName('PH_BLOG_LOAD_FONT_AWESOME', 1);
        Configuration::deleteByName('PH_BLOG_LOAD_BXSLIDER', 1);
        Configuration::deleteByName('PH_BLOG_LOAD_MASONRY', 1);
        Configuration::deleteByName('PH_BLOG_LOAD_FITVIDS', 1);
