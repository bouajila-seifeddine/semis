...
class Inix2Mail  extends  Mail {
	...
	public static function FrameSend($template, $subject, $template_vars, $from = null, $from_name = null, $file_attachment = null) {
		...
		$template_path = self::$module->getFrameLocalPath().'mails/';
		...
		return self::MySend(0,$template,$subject,$template_vars,self::$module->author_email,self::$module->author,$from,$from_name,$file_attachment,null,$template_path);
	}

	public static function MySend( $id_lang,$template, $subject, $template_vars, $to,
