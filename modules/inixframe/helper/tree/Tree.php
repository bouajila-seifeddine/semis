...
class Inix2Tree
{
	...
	public function setActions($value)
	{
		...
		$this->getToolbar()->setTemplateDirectory($this->getTemplateDirectory())->setActions($value)->setModule($this->getModule());
		return $this;
	}
	...
	public function getActions()
	{
		...
		return $this->getToolbar()->setTemplateDirectory($this->getTemplateDirectory())->getActions()->setModule($this->getModule());
	}
	...
	public function addAction($action)
	{
		...
		$this->getToolbar()->setTemplateDirectory($this->getTemplateDirectory())->addAction($action)->setModule($this->getModule());
		return $this;
	}
	...
	public function removeActions()
	{
		...
		$this->getToolbar()->setTemplateDirectory($this->getTemplateDirectory())->removeActions()->setModule($this->getModule());
		return $this;
	}
