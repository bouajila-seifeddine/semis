...
<div id="color_2_1_2" width="600" align="center" valign="top" style="background-color:#FFFFFF;">
    <input id="color_picker_2_1_2" class="color" name="color_picker_2_1_2"
    onchange="updateColor('color_2_1_2',this.color.toString());" value="FFFFFF" />
    ...
    <table width="600" border="0" cellpadding="0" cellspacing="0">
        <tbody>
        <tr><td id="color_2_2_2" bgcolor="#FFFFFF">
            <input id="color_picker_2_2_2" class="color" name="color_picker_2_2_2" onchange="updateColor('color_2_2_2',this.color.toString())" value="FFFFFF" />
            <table width="600" border="0" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td width="280" align="left" valign="top" style="padding: 5px;">
                                            <textarea name="center_2_1_2" id="tpl2_center_1_2"></textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="280" height="35" align="left" style="padding: 5px;">
                                            <textarea name="center_2_2_2" id="tpl2_center_2_2"></textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <tbody>
                            <tr>
                                <td width="40" height="32" align="center">
                                    <textarea name="center_2_3_2" id="tpl2_center_3_2">
                                    <table>
                                                    <tr>
