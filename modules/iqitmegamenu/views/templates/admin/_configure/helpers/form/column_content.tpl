	...
	<div class="menu-column-content">
		<p>
			...
			<select class="select-column-width">
				{for $i=1 to 12}
				<option value="{$i|escape:'htmlall':'UTF-8'}" {if isset($node.width)}{if $node.width==$i}selected{/if}{else}{if $i==3}selected{/if}{/if}>{$i|escape:'htmlall':'UTF-8'}/12</option>
				{/for}
			</select>
		</p>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}" {if $language.id_lang != $defaultFormLanguage}style="display:none"{/if}>
								{/if}
								<div class="col-lg-7">
									<input value="{if isset($node.content_s.title[$language.id_lang])}{$node.content_s.title[$language.id_lang]|escape:'htmlall':'UTF-8'}{/if}" type="text" class="column-title-{$language.id_lang|escape:'htmlall':'UTF-8'}">
									<p class="help-block">
						...
						<div class="form-group">
							...
							<div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}" {if $language.id_lang != $defaultFormLanguage}style="display:none"{/if}>
								{/if}
								<div class="col-lg-7">
									<input value="{if isset($node.content_s.href[$language.id_lang])}{$node.content_s.href[$language.id_lang]|escape:'htmlall':'UTF-8'}{/if}" type="text" class="column-href-{$language.id_lang|escape:'htmlall':'UTF-8'}">
									<p class="help-block">
						...
						<div class="form-group">
							...
							<div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}" {if $language.id_lang != $defaultFormLanguage}style="display:none"{/if}>
								{/if}
								<div class="col-lg-7">
									<input value="{if isset($node.content_s.legend[$language.id_lang])}{$node.content_s.legend[$language.id_lang]|escape:'htmlall':'UTF-8'}{/if}" type="text" class="column-legend-{$language.id_lang|escape:'htmlall':'UTF-8'}">
									<p class="help-block">
					...
					<div class="htmlcontent-wrapper content-options-wrapper">
							...
							<option value="{$customhtml.id_html|escape:'htmlall':'UTF-8'}" {if isset($node.content.ids) && $node.content.ids == $customhtml.id_html}selected{/if} >{$customhtml.title|escape:'htmlall':'UTF-8'}</option>
							{/foreach}
							</select>
						...
						<div class="form-group">
								...
								<select class="select-categories-ids col-lg-9" multiple="multiple" style="height: 160px;">
									{foreach from=$categories_select item=category}
										<option value="{$category.id|escape:'htmlall':'UTF-8'}" {if isset($node.content.ids) && $node.contentType == 2 && in_array($category.id, $node.content.ids)}selected{/if} disabled>{$category.name|escape:'htmlall':'UTF-8'}</option>
							...
							<div class="form-group">
								...
								<select class="select-categories-sublimit">
									{for $i=5 to 60 step 5}
										<option value="{$i|escape:'htmlall':'UTF-8'}" {if isset($node.content.sublimit)}{if $node.content.sublimit==$i}selected{/if}{else}{if $i==15}selected{/if}{/if}>{$i|escape:'htmlall':'UTF-8'}</option>
									{/for}
								</select>
							<p class="help-block">
					...
					<div class="va-links-wrapper content-options-wrapper {if isset($node.elementId)}va-links-wrapper-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}">
							<div class="form-group">
								<label class="control-label col-lg-3">{l s='Select links' mod='iqitmegamenu'}</label>
								{*HTML CONTENT*} {$va_links_select} 
								{if isset($node.content.ids) && $node.contentType == 3}
								<script>
								$(".{if isset($node.elementId)}va-links-wrapper-{$node.elementId|escape:'htmlall':'UTF-8'}{/if} .select-links-ids").val({$node.content.ids|json_encode});	
								</script>
								{/if}
							</div>
							<div class="form-group">
					...
					<div class="column-image-wrapper content-options-wrapper">
						...
						<div class="form-group">
							...
							<div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}" {if $language.id_lang != $defaultFormLanguage}style="display:none"{/if}>
								{/if}
								<div class="col-lg-7">
									<input value="{if isset($node.content.source[$language.id_lang])}{$node.content.source[$language.id_lang]|escape:'htmlall':'UTF-8'}{/if}" type="text" class="image-source image-source-{$language.id_lang|escape:'htmlall':'UTF-8'}" name="{if isset($node.elementId)}{$node.elementId|escape:'htmlall':'UTF-8'}-{/if}image-source-{$language.id_lang|escape:'htmlall':'UTF-8'}"  id="{if isset($node.elementId)}{$node.elementId|escape:'htmlall':'UTF-8'}-{/if}image-source-{$language.id_lang|escape:'htmlall':'UTF-8'}" data-lang-id="{$language.id_lang|escape:'htmlall':'UTF-8'}" >
									<a href="filemanager/dialog.php?type=1&field_id={if isset($node.elementId)}{$node.elementId|escape:'htmlall':'UTF-8'}-{/if}image-source-{$language.id_lang|escape:'htmlall':'UTF-8'}" class="btn btn-default iframe-column-upload"  data-input-name="{if isset($node.elementId)}{$node.elementId|escape:'htmlall':'UTF-8'}-{/if}image-source-{$language.id_lang|escape:'htmlall':'UTF-8'}" type="button">{l s='Select image' mod='iqitmegamenu'} <i class="icon-angle-right"></i></a>
								</div>
								{if $languages|count > 1}
								<div class="col-lg-2">
									<button type="button" class="btn btn-default dropdown-toggle" tabindex="-1" data-toggle="dropdown">
						...
						<div class="form-group">
							...
							<div class="translatable-field lang-{$language.id_lang|escape:'htmlall':'UTF-8'}" {if $language.id_lang != $defaultFormLanguage}style="display:none"{/if}>
								{/if}
								<div class="col-lg-7">
									<input value="{if isset($node.content.href[$language.id_lang])}{$node.content.href[$language.id_lang]|escape:'htmlall':'UTF-8'}{/if}" type="text" class="image-href-{$language.id_lang|escape:'htmlall':'UTF-8'}">
									<p class="help-block">
								{l s='Optional link. Use entire url with http:// prefix' mod='iqitmegamenu'}
							</p>
								</div>
						...
						<div class="form-group">
								...
								<div class="col-lg-9">
								<input value="{if isset($node.content.i_a_t)}{$node.content.i_a_t|escape:'htmlall':'UTF-8'}{/if}" type="text" class="image-absolute-t">
								</div>
						</div>
						<div class="form-group">
								<label  class="control-label col-lg-3">{l s='Right' mod='iqitmegamenu'}</label>
								<div class="col-lg-9">
								<input value="{if isset($node.content.i_a_r)}{$node.content.i_a_r|escape:'htmlall':'UTF-8'}{/if}" type="text" class="image-absolute-r">
								</div>
						</div>
						<div class="form-group">
								<label  class="control-label col-lg-3">{l s='Bottom' mod='iqitmegamenu'}</label>
								<div class="col-lg-9">
								<input value="{if isset($node.content.i_a_b)}{$node.content.i_a_b|escape:'htmlall':'UTF-8'}{/if}" type="text" class="image-absolute-b">
								</div>
						</div>
						<div class="form-group">
								<label  class="control-label col-lg-3">{l s='Left' mod='iqitmegamenu'}</label>
								<div class="col-lg-9">
								<input value="{if isset($node.content.i_a_l)}{$node.content.i_a_l|escape:'htmlall':'UTF-8'}{/if}" type="text" class="image-absolute-l">
								</div>
						</div>
					...
					<div class="products-wrapper content-options-wrapper">
							...
							<div class="form-group">
								...
								{foreach from=$node.content.ids item=product}
									<option value="{$product.id_product|escape:'htmlall':'UTF-8'}" >(ID: {$product.id_product|escape:'htmlall':'UTF-8'}) {$product.name|escape:'htmlall':'UTF-8'}</option>
								{/foreach}
								{/if}
								</select>
								<br />
						...
						<div class="form-group">
								...
								<select class="select-manufacturers-ids col-lg-9" multiple="multiple" style="height: 160px;">
									{foreach from=$manufacturers_select item=manufacturer}
										<option value="{$manufacturer.id|escape:'htmlall':'UTF-8'}" {if isset($node.content.ids) && $node.contentType == 5 && in_array($manufacturer.id, $node.content.ids)}selected{/if} >{$manufacturer.name|escape:'htmlall':'UTF-8'}</option>
									{/foreach}
								</select>
							</div>
							<div class="form-group">
						...
						<div class="form-group">
								...
								<select class="select-suppliers-ids col-lg-9" multiple="multiple" style="height: 160px;">
									{foreach from=$suppliers_select item=supplier}
										<option value="{$supplier.id|escape:'htmlall':'UTF-8'}" {if isset($node.content.ids) && $node.contentType == 7 && in_array($supplier.id, $node.content.ids)}selected{/if} >{$supplier.name|escape:'htmlall':'UTF-8'}</option>
									{/foreach}
								</select>
							</div>
							<div class="form-group">
								...
								<div class="col-lg-10">
									<div class="row">
										<div class="input-group">
											<input type="text" data-hex="true" class="column_bg_color {if isset($node.elementId)}column_bg_color-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}"	name="column_bg_color" value="{if isset($node.content_s.bg_color)}{$node.content_s.bg_color|escape:'htmlall':'UTF-8'}{/if}" />
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-3 ">
							<div class="form-group">
								<div class="col-lg-12">
									<div class="row">
										<div class="input-group">
											<input type="text" data-hex="true" class="title_borderc {if isset($node.elementId)}title_borderc-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}" value="{if isset($node.content_s.title_borderc)}{$node.content_s.title_borderc|escape:'htmlall':'UTF-8'}{/if}" />
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-3 ">
							<div class="form-group">
								<div class="col-lg-12">
									<div class="row">
										<div class="input-group">
											<input type="text" data-hex="true" class="title_color {if isset($node.elementId)}title_color-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}" value="{if isset($node.content_s.title_color)}{$node.content_s.title_color|escape:'htmlall':'UTF-8'}{/if}" />
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-3 ">
							<div class="form-group">
								<div class="col-lg-12">
									<div class="row">
										<div class="input-group">
											<input type="text" data-hex="true" class="title_colorh {if isset($node.elementId)}title_colorh-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}" value="{if isset($node.content_s.title_colorh)}{$node.content_s.title_colorh|escape:'htmlall':'UTF-8'}{/if}" />
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-3 ">
							<div class="form-group">
								<div class="col-lg-12">
									<div class="row">
										<div class="input-group">
											<input type="text" data-hex="true" class="legend_bg {if isset($node.elementId)}legend_bg-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}"	name="legend_bg" value="{if isset($node.content_s.legend_bg)}{$node.content_s.legend_bg|escape:'htmlall':'UTF-8'}{/if}" />
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-3 ">
							<div class="form-group">
								<div class="col-lg-12">
									<div class="row">
										<div class="input-group">
											<input type="text" data-hex="true" class="legend_txt {if isset($node.elementId)}legend_txt-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}"	name="legend_txt" value="{if isset($node.content_s.legend_txt)}{$node.content_s.legend_txt|escape:'htmlall':'UTF-8'}{/if}" />
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-3 ">
							<div class="form-group">
								<div class="col-lg-12">
									<div class="row">
										<div class="input-group">
											<input type="text" data-hex="true" class="txt_color {if isset($node.elementId)}txt_color-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}" value="{if isset($node.content_s.txt_color)}{$node.content_s.txt_color|escape:'htmlall':'UTF-8'}{/if}" />
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-3 ">
							<div class="form-group">
								<div class="col-lg-12">
									<div class="row">
										<div class="input-group">
											<input type="text" data-hex="true" class="txt_colorh {if isset($node.elementId)}txt_colorh-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}" value="{if isset($node.content_s.txt_colorh)}{$node.content_s.txt_colorh|escape:'htmlall':'UTF-8'}{/if}" />
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row">
										...
										<div class="col-xs-3">
											<select name="br_top_wh" class="br_top_wh">
												{for $i=1 to 10}
												<option value="{$i|escape:'htmlall':'UTF-8'}" {if isset($node.content_s.br_top_wh)}{if $i==$node.content_s.br_top_wh}selected{/if}{else}{if $i==1}selected{/if}{/if}>{$i|escape:'htmlall':'UTF-8'}px</option>
												{/for}
											</select>
										...
										<div class="col-xs-3">
											<div class="form-group">
												<div class="col-xs-12">
													<div class="row">
														<div class="input-group">
															<input type="text" data-hex="true" class="br_top_c {if isset($node.elementId)}br_top_c-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}" value="{if isset($node.content_s.br_top_c)}{$node.content_s.br_top_c|escape:'htmlall':'UTF-8'}{/if}" />
														</div>
													</div>
												</div>
											</div>
									...
									<div class="row">
										...
										<div class="col-xs-3">
											<select name="br_right_wh" class="br_right_wh">
												{for $i=1 to 10}
												<option value="{$i|escape:'htmlall':'UTF-8'}" {if isset($node.content_s.br_right_wh)}{if $i==$node.content_s.br_right_wh}selected{/if}{else}{if $i==1}selected{/if}{/if}>{$i|escape:'htmlall':'UTF-8'}px</option>
												{/for}
											</select>
										...
										<div class="col-xs-3">
											<div class="form-group">
												<div class="col-xs-12">
													<div class="row">
														<div class="input-group">
															<input type="text" data-hex="true" class="br_right_c {if isset($node.elementId)}br_right_c-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}" value="{if isset($node.content_s.br_right_c)}{$node.content_s.br_right_c|escape:'htmlall':'UTF-8'}{/if}" />
														</div>
													</div>
												</div>
											</div>
									...
									<div class="row">
										...
										<div class="col-xs-3">
											<select name="br_bottom_wh" class="br_bottom_wh">
												{for $i=1 to 10}
												<option value="{$i|escape:'htmlall':'UTF-8'}" {if isset($node.content_s.br_bottom_wh)}{if $i==$node.content_s.br_bottom_wh}selected{/if}{else}{if $i==1}selected{/if}{/if}>{$i|escape:'htmlall':'UTF-8'}px</option>
												{/for}
											</select>
										...
										<div class="col-xs-3">
											<div class="form-group">
												<div class="col-xs-12">
													<div class="row">
														<div class="input-group">
															<input type="text" data-hex="true" class="br_bottom_c {if isset($node.elementId)}br_bottom_c-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}" value="{if isset($node.content_s.br_bottom_c)}{$node.content_s.br_bottom_c|escape:'htmlall':'UTF-8'}{/if}" />
														</div>
													</div>
												</div>
											</div>
									...
									<div class="row">
										...
										<div class="col-xs-3">
											<select name="br_left_wh" class="br_left_wh">
												{for $i=1 to 10}
												<option value="{$i|escape:'htmlall':'UTF-8'}" {if isset($node.content_s.br_left_wh)}{if $i==$node.content_s.br_left_wh}selected{/if}{else}{if $i==1}selected{/if}{/if}>{$i|escape:'htmlall':'UTF-8'}px</option>
												{/for}
											</select>
										...
										<div class="col-xs-3">
											<div class="form-group">
												<div class="col-xs-12">
													<div class="row">
														<div class="input-group">
															<input type="text" data-hex="true" class="br_left_c {if isset($node.elementId)}br_left_c-{$node.elementId|escape:'htmlall':'UTF-8'}{/if}" value="{if isset($node.content_s.br_left_c)}{$node.content_s.br_left_c|escape:'htmlall':'UTF-8'}{/if}" />
														</div>
													</div>
												</div>
											</div>
