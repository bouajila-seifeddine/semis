...
class Ph_ReviewsCarouselOverride extends Ph_ReviewsCarousel
{
...
public function hookDisplayAfterContent($params)
    {
        ...
        return $this->display(__FILE__, 'reviews-after-content.tpl');
    }
