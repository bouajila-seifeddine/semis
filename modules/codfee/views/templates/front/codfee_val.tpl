...
{else}
	...
	<form action="{if version_compare($smarty.const._PS_VERSION_, '1.5', '<')}{$this_path_ssl}payment.php{else}{$link->getModuleLink('codfee', 'validation', [], true)|escape:'htmlall':'UTF-8'}{/if}" method="post">
	<p>
		<img src="{$this_path|escape:'htmlall':'UTF-8'}img/codfee.gif" alt="{l s='Cash on delivery with fee payment' mod='codfee'}" style="float:left; margin: 0px 10px 5px 0px;" />
		<br />
