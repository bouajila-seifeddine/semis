...
<div class="company">
	<div class="logo">
		<img src="{$cf_path|escape:'htmlall':'UTF-8'}img/logo_idnovate.png" title="idnovate.com" alt="idnovate.com" />
	</div>
	<div class="content">
...
<div class="instructions">
	<img src="{$cf_path|escape:'htmlall':'UTF-8'}img/codfee.gif" style="float:left; margin-right:15px;" />
