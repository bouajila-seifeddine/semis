...
class HomeFeatured extends Module
{
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submitHomeFeatured'))
		{
			...
			else
			{
				...
				Configuration::updateValue('HOME_FEATURED_CAT', $cat);
	...
	public function _cacheProducts()
	{
		if (!isset(HomeFeatured::$cache_products))
		{
			...
			$productIds = Configuration::get('HOME_FEATURED_CAT');
			$nb = (int)Configuration::get('HOME_FEATURED_NBR');
			if (Configuration::get('HOME_FEATURED_RANDOMIZE'))
				HomeFeatured::$cache_products = $category->getProductsCustom((int)Context::getContext()->language->id, 1, ($nb ? $nb : 8), null, null, false, true, true, ($nb ? $nb : 8));
			else
				HomeFeatured::$cache_products = $category->getProductsCustom((int)Context::getContext()->language->id, 1, ($nb ? $nb : 8), 'position');
		}
		...
		$fields_form = array(
			'form' => array(
				...
				'input' => array(
					...
					array(
						'type' => 'text',
						'label' => $this->l('Introduce los Ids de los productos a mostrar. Ejemplo: 001,002,003,004,005'),
