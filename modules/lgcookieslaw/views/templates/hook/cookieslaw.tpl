...
<div class="lgcookieslaw_banner">
	<form method="post" action="#">
		{if $buttons_position == 2 }
			...
			<a class="lgcookieslaw_btn" {if isset($cms_target) && $cms_target} target="_blank" {/if} href="{$cms_link|escape:'quotes':'UTF-8'}" >{stripslashes($button2|escape:'quotes':'UTF-8')}
			</a>
		{/if}
		<div class="" style="display:table; margin:0 auto;">
			...
			{/if}
			<div style="display:table-cell; vertical-align: middle; padding:5px 25px 5px 5px;" >{stripslashes($cookie_message|escape:'quotes':'UTF-8')}</div>
