  ...
  <div class="row innova-banner">
    <div class="innovacolumna1">
      <div class="innova-logo">
        <a href="https://www.prestashop.com/{$link_iso|escape:'htmall':'UTF-8'}/web-agency-partners/gold/innovadeluxe"  target="blank">
      ...
      <div class="block-services">
        ...
        <a href="{$module_dir|escape:'htmlall':'UTF-8'}doc/{$link_iso|escape:'htmall':'UTF-8'}.pdf" target="blank">
          <i class="icon-file-text"></i>
          <span>{$suggested_modules.$link_iso.texto_ayuda|escape:'htmlall':'UTF-8'}</span>
        </a>
        <a href="http://addons.prestashop.com/{$link_iso|escape:'htmall':'UTF-8'}/ratings.php" target="blank">
          <i class="icon-comments"></i>
          <span>{$suggested_modules.$link_iso.texto_opinion|escape:'htmlall':'UTF-8'}</span>
        </a>
      </div>
      <div class="interesting-modules">
        <a href="http://addons.prestashop.com/{$link_iso|escape:'htmall':'UTF-8'}/76_innovadeluxe" target="blank">
    ...
    <div class="innovacolumna2">
      <div class="module-info">
        <a href="http://addons.prestashop.com/{$link_iso|escape:'htmall':'UTF-8'}/product.php?id_product={$suggested_modules.id_modulo1|intval}" target="blank">
        ...
        <a href="http://addons.prestashop.com/{$link_iso|escape:'htmall':'UTF-8'}/product.php?id_product={$suggested_modules.id_modulo2|intval}" target="blank">
        ...
        <a href="http://addons.prestashop.com/{$link_iso|escape:'htmall':'UTF-8'}/product.php?id_product={$suggested_modules.id_modulo3|intval}" target="blank">
