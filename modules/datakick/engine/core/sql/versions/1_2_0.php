...
class MigrationVersion_1_2_0 extends MigrationVersion {
  ...
  protected function getData() {
    return array(
      ...
      'task-type' => array(
        array('type' => 'xml-preview', 'name' => 'XML preview'),
        array('type' => 'xml-feed', 'name' => 'XML feed'),
        array('type' => 'xml-file', 'name' => 'XML file'),
        array('type' => 'list-preview', 'name' => 'List'),
  ...
  public function migrateData($factory, $conn) {
    $this->insert('task-type', array(
      array('type' => 'list-preview', 'name' => 'List'),
      array('type' => 'csv-feed', 'name' => 'CSV feed'),
      array('type' => 'csv-file', 'name' => 'CSV file')
    ));
    $this->update('task-type',
      array('name' => 'XML preview'),
      array('type' => 'xml-preview')
    );
    return true;
  }
}
