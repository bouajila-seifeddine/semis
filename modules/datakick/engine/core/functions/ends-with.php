...
class EndsWithFunction extends Func {
    public function __construct() {
      parent::__construct('endsWith', 'boolean', array(
    ...
    public function jsEvaluate() {
      return "return haystack && needle && haystack.toLowerCase().endsWith(needle.toLowerCase);";
    }
