...
class ContainsFunction extends Func { public function __construct() {
      parent::__construct('contains', 'boolean', array(
    ...
    public function jsEvaluate() {
      return "return haystack && needle && haystack.toLowerCase().contains(needle.toLowerCase);";
    }
