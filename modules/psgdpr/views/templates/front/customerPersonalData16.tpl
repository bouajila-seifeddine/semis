...
{capture name=path}
    <a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
        {l s='My account' mod='psgdpr'}
    </a>
    <span class="navigation-pipe">></span>
    <span class="navigation_page">{l s='My personal data' mod='psgdpr'}</span>
{/capture}
