                ...
                {if $languages|count > 1}
                    ...
                    <div class="col-lg-9">
                        ...
                        {if isset($fields_value['image']) && $fields_value['image'][$language.id_lang] != ''}
                            <img src="{$image_baseurl|escape:'UTF-8'}{$language.iso_code|escape:'html':'UTF-8'}/{$fields_value['image'][$language.id_lang]|escape:'UTF-8'}" class="img-thumbnail" /><br><br>
                        {/if}
                        ...
                        <div class="dummyfile input-group">
                            ...
                            <span class="input-group-btn">
                                <button id="{$input.name|escape:'html':'UTF-8'}_{$language.id_lang|intval}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
                                    <i class="icon-folder-open"></i> {l s='Choose a file' mod='ph_bannermanager'}
                                </button>
                            </span>
                        </div>
                    </div>
