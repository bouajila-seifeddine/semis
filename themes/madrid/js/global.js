...
// Find the distance between now and the count down date
  ...
  var containerHoras = document.getElementById("horas-timer");
  var containerMinutos = document.getElementById("minutos-timer");
  var containerSegundos = document.getElementById("segundos-timer");

  if(containerHoras != null){
	  containerHoras.innerHTML = hours;
	  containerMinutos.innerHTML = minutes;
	  containerSegundos.innerHTML = seconds;
    
 	 // If the count down is over, write some text 
	  if (distance < 0) {
   	 clearInterval(x);
  	  containerHoras.innerHTML = "OFERTA EXPIRADA";
 	 }
  }
}, 1000);
