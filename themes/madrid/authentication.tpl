...
{if !isset($email_create)}
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="std box">
				<h3 class="page-heading"><span>{l s='Create an account'}</span></h3>
				<div class="form_content clearfix">
					...
					<div class="submit">
						...
						<button class="button btn-primary" type="submit" id="SubmitCreate" name="SubmitCreate">
							<span>
		...
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="std box">
		...
		<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std clearfix">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					<h3 class="page-heading bottom-indent"><span>{l s='Instant checkout'}</span></h3>
					<!-- Account -->
					...
					{/if}
					<h3 class="page-heading bottom-indent top-indent"><span>{l s='Delivery address'}</span></h3>
			...
			<p class="cart_navigation required submit clearBoth">
				<span><sup>*</sup>{l s='Required field'}</span><br /><br />
				<input type="hidden" name="display_guest_checkout" value="1" />
				<button type="submit" class="clearBoth pull-left button btn-primary" name="submitGuestAccount" id="submitGuestAccount">
					<span>
...
{else}
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			<h3 class="page-heading"><span>{l s='Your personal information'}</span></h3>
		...
		{if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
			<div class="account_creation">
				<h3 class="page-heading">{l s='Your address'}</h3>
				{foreach from=$dlv_all_fields item=field_name}
					{if $field_name eq "company"}
						{if !$b2b_enable}
							<p class="form-group">
		...
		<div class="submit clearfix">
			...
			{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
			<button type="submit" name="submitAccount" id="submitAccount" class="button">
