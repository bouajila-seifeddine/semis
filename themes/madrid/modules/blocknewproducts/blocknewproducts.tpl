...
<div id="new-products_block_right" class="block products_block">
    ...
    <div class="block_content">
        {if $new_products !== false}
            ...
            <div>
                <a href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='All new products' mod='blocknewproducts'}" class="button button-small"><span>{l s='All new products' mod='blocknewproducts'}</span></a>
            </div>
        {else}
