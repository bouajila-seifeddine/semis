	...
	<table id="order-list" class="table table-bordered">
		...
		<tfoot>
			<tr class="alternate_item">
				...
				<td class="history_method" style="text-align:center;">{$totalPoints|intval}</td>
...
<h1>{l s='My vouchers from loyalty points' mod='loyalty'}</h1>
...
<ul class="footer_links clearfix">
	<li>
		<a class="button button-small" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Back to Your Account' mod='loyalty'}" rel="nofollow"><span><i class="icon icon-chevron-left"></i> {l s='Back to Your Account' mod='loyalty'}</span></a>
	</li>
	<li>
		<a class="button button-small" href="{$base_dir}" title="{l s='Home' mod='loyalty'}"><span>{l s='Home' mod='loyalty'}</span></a>
	</li>
</ul>
