...
<div class="col-md-6 col-sm-6 col-xs-12">
	<form class="box row" id="compare_shipping_form" method="post" action="#" >
		<fieldset id="compare_shipping">
			<h4><span>{l s='Estimate the cost of shipping & taxes.' mod='carriercompare'}</span></h4>
			...
			<div id="availableCarriers" class="clearBoth" style="display: none;">
				<table cellspacing="0" cellpadding="0" id="availableCarriers_table" class="table">
					<thead>
						<tr>
			...
			<p class="SE_SubmitRefreshCard">
	            <button class="button button-small" id="carriercompare_submit" type="button" name="carriercompare_submit">
	            	<span>{l s='Update cart' mod='carriercompare'}</span>
	            </button>
	            <button id="update_carriers_list" type="button" class="button button-small">
