<section class="page-product-box ph_relatedposts">
	<div class="heading_block">
		<h3 class="page-product-heading">
			<i class="icon icon-file-text main-color"></i>
			{l s='Related posts' mod='ph_relatedposts'}</h3>
	</div>
						...
						{else}
							...
							<div class="post-content" itemprop="text">
								...
								<div class="post-read-more">
									<a class="button btn-primary button-small" href="{$post.url|escape:'html':'UTF-8'}" title="{l s='Read more' mod='ph_relatedposts'}">
										{l s='Read more' mod='ph_relatedposts'} <i class="icon icon-arrow-circle-right"></i>
									</a>
								</div><!-- .post-read-more -->
								{/if}
							</div><!-- .post-content -->	
