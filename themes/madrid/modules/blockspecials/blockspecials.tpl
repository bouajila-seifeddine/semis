...
<div id="special_block_right" class="block">
    ...
    {if $special}
        <ul class="products nolist">
            <li>
                <div class="col-xs-4">
                    <div class="row">
                        <a class="products-block-image" title="{$special.name|escape:'html':'UTF-8'}" href="{$special.link|escape:'html':'UTF-8'}">
                            <img src="{$link->getImageLink($special.link_rewrite, $special.id_image, 'tm_small_default')|escape:'html':'UTF-8'}" alt="{$special.name|escape:'html':'UTF-8'}" class="img-responsive" />
                        </a>
                    </div>
                </div>
                <div class="product-content col-xs-8">
                    <h5><a href="{$special.link|escape:'html':'UTF-8'}" title="{$special.name|escape:'html':'UTF-8'}">{$special.name|escape:'html':'UTF-8'|truncate:40}</a></h5>
                    <div class="price-box">
                        {if !$PS_CATALOG_MODE}
                        <span class="price">
                            {if !$priceDisplay}
		...
		<div>
			<a 
            class="button btn-primary button-small" 
    ...
    {else}
		<div>{l s='No specials products at this time.' mod='blockspecials'}</div>
    {/if}
	</div>
</div>
<!-- /MODULE Block specials -->