...
<form class="std clearfix" action="{$post->url|escape:'html':'UTF-8'}" method="post">
	<fieldset>
		<div class="box">
			<h3 class="page-heading bottom-indent"><span>{l s='New comment' mod='ph_simpleblog'}</span></h3>
		...
		<p class="cart_navigation required submit clearBoth">
			...
			{if $is_16}
			<button type="submit" class="pull-left button btn-primary" name="submitNewComment" id="submitNewComment">
				<span>
