...
{*<div id="search_block_top" class="col-lg-offset-3 col-md-offset-2 col-sm-offset-1 col-md-3 col-sm-4 col-xs-12">
	<form method="get" action="{$link->getPageLink('search', null, null, null, false, null, true)|escape:'html':'UTF-8'}" id="searchbox" class="row">
		<p>
			...
			<input class="search_query" type="text" id="search_query_top" name="search_query" placeholder="{l s='Type to search...' mod='blocksearch'}" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}" />
			<span>
				<i class="icon icon-search"></i>
				<input class="main-color" type="submit" value="{l s='ok' mod='blocksearch'}" />
			</span>
		</p>
	</form>
