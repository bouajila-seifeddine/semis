	...
	<div id="product_comments_block_tab">
		{if $comments}
						...
						<ul>
							...
							{if $is_logged}
								...
								<li>
									...
									<button class="usefulness_btn button button-small" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">
										<span>{l s='Yes' mod='productcomments'}</span>
									</button>
									<button class="usefulness_btn button button-small" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">
			...
			<p class="align_center">
				<a id="new_comment_tab_btn" class="button button-small open-comment-form" href="#new_comment_form">
			...
			<div class="row">
				{if isset($product) && $product}
					<div class="product clearfix  col-xs-12 col-sm-6">
						<img class="img-responsive" src="{$productcomment_cover_image|replace:'medium_':'home_'}" alt="{$product->name|escape:'html':'UTF-8'}" />
