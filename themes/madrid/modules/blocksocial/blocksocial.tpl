...
<section id="social_block" class="pull-right">
	<ul>
		{if isset($facebook_url) && $facebook_url != ''}
			<li class="facebook">
				<a class="_blank" rel="nofollow" href="{$facebook_url|escape:html:'UTF-8'}">
		...
		{if isset($twitter_url) && $twitter_url != ''}
			<li class="twitter">
				<a class="_blank" rel="nofollow" href="{$twitter_url|escape:html:'UTF-8'}">
		...
		{if isset($rss_url) && $rss_url != ''}
			<li class="rss">
				<a class="_blank" rel="nofollow" href="{$rss_url|escape:html:'UTF-8'}">
        ...
        {if isset($youtube_url) && $youtube_url != ''}
        	<li class="youtube">
        		<a class="_blank" rel="nofollow" href="{$youtube_url|escape:html:'UTF-8'}">
        ...
        {if isset($google_plus_url) && $google_plus_url != ''}
        	<li class="google-plus">
        		<a class="_blank" rel="nofollow" href="{$google_plus_url|escape:html:'UTF-8'}">
