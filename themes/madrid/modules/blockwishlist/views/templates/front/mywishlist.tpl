...
<div id="mywishlist">
	...
	{if $id_customer|intval neq 0}
		<form method="post" class="std box" id="form_wishlist">
			<fieldset>
				<h3 class="page-subheading"><span>{l s='New wishlist' mod='blockwishlist'}</span></h3>
				...
				<p class="submit">
                    <button id="submitWishlist" class="button" type="submit" name="submitWishlist">
	...
	<ul class="footer_links clearfix">
		...
		<li>
			<a class="button button-small" href="{$base_dir|escape:'html':'UTF-8'}">
				<span>
