...
{if $theme_options['autoplay_carousels_start']}
	{addJsDef autoplayInfo=true}
{else}
	{addJsDef autoplayInfo=false}
{/if}

{if $theme_options['autoplay_carousels']}
	{addJsDef autoplay_speed=$theme_options['autoplay_carousels']}
{/if}
{/strip}