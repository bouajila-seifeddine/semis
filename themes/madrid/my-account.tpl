...
<div class="row addresses-lists">
	<div class="col-xs-12 col-sm-6">
		<ul class="myaccount-link-list">
            ...
            <li><a href="{$link->getPageLink('addresses', true)|escape:'html':'UTF-8'}" title="{l s='Addresses'}"><i class="icon icon-building"></i><span>{l s='My addresses'}</span></a></li>
...
<li><a class="button button-small" href="{$base_dir}" title="{l s='Home'}"><span><i class="icon icon-chevron-left"></i> {l s='Home'}</span></a></li>
</ul>
