...
{else}
	...
	<div class="bottom-footer">
		<div class="container">
			&copy; <span class="current-year">{'Y'|date}</span> {l s='[1] %s[/1]' mod='blockcms' sprintf=['SemillasLowCost'] tags=['<a class="_blank" title="SemillasLowCost" href="https://www.semillaslowcost.com">']}
		</div>
	</div>
	{/if}
	<!-- /MODULE Block footer -->
