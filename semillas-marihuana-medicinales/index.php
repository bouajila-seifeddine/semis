   ...
   <html class="no-js lt-ie9 lt-ie8 ie7" lang="es-es">
      ...
      <html class="no-js lt-ie9 ie8" lang="es-es">
         ...
         <html class="no-js ie9" lang="es-es">
                ...
                .category-head {
                 ...
                 .ac_results{
                  ...
                  .ac_results li{
                   ...
                   #search_query_top {
                        margin-left: 16px;
                        border: 0px solid #2c313b;
                        border-right: 0px solid #2c313b;
                        width: 66%;
                        background: white;
                   ...
                   .asagiSabit {
                    ...
                    #categorias-logos{ width: 100%;text-align: center; }
                   ...
                   @media (max-width: 998px) {
                     ...
                     .mobile_menu{ max-height: 100%; position: fixed;overflow-y: auto;margin-top: -27px; padding-right: 13%; left: 19px; background: transparent !important;top: 44px;}
                 ...
                 button {
                  ...
                  a .titulo-categoria:hover {color:black !important; font: 207% sans-serif;}

                   .infodiv p{margin-top: 1%;}
                   #search_block_top i {
                       font-size: 24px
                    }
            ...
            i.pull-left.icon.icon-shopping-cart.main-color {
               background: #7bbd42
            }
            .main-box .icon i {
               background: #7bbd42
       ...
       .prefooter .block_footer.block_contact .item,
        ...
        header.top .pattern {
           background: url(https://www.semillaslowcost.com/themes/madrid/css/autoload/../../images/colors/header2.png) repeat-x top center!important
        }
        .telefonodiv {
            float: left;
            margin-top: 1%;
    ...
    .ph_megamenu_mobile_toggle {
      ...
      #search_block_top {
        ...
        .mobile_menu{ 
             ...
             position: fixed;
             overflow-y: auto;
             margin-top: -27px; padding-right: 13%;
             left: 19px; background: transparent !important;
             top: 44px;}
     ...
     @media (max-width: 1000px) {
      ...
      .shopping_cart_mobile span.ajax_cart_no_product{color:white !important; } 
                  ...
                  <div class="boxed-wrapper">
                        ...
                        <div class="container">
                           ...
                           <div class="col-lg-3 col-md-4 shopping_cart shopping_cart_desktop pull-right">
                              <div class="row">
                                 ...
                                 <a id="showCart" class="cart-contents" href="https://www.semillaslowcost.com/pedido-rapido" title="Ver mi carrito de compra" rel="nofollow">
                           ...
                           <div id="layer_cart">
                              <div class="clearfix">
                                 ...
                                 <div class="layer_cart_cart col-xs-12 col-md-6">
                                    ...
                                    <div class="layer_cart_row">
                                       <strong class="dark">
                                       Total (impuestos inc.) </strong>
                                       <span class="ajax_block_cart_total">
                                       </span>
                                    </div>
                                    <div class="button-container">
                                       <span class="continue button" title="Seguir comprando">
                                       <span>
                                       Seguir comprando </span>
                                       </span>
                                       <a class="button btn-primary" href="https://www.semillaslowcost.com/pedido-rapido" title="Ir a la caja" rel="nofollow">
                                       <span>
                                       Ir a la caja </span>
                                       </a>
                                    </div>
                     ...
                     <p>  En la industria farmacéutica, debería ser una prioridad el encontrar medicamentos sin apenas efectos adversos pero con muchas virtudes terapéuticas, y el CBD es uno de ellos. Además, por sí solo no posee ningún efecto psicoactivo o alucinógeno. Dicha característica lo convierten en el elemento cannabinoide más estudiado por científicos y médicos de todo el mundo, además de sus múltiples posibles usos. Por ejemplo, en el mundo de la medicina y de los medicamentos es muy habitual el uso de sustancias sedantes e inhibidoras del dolor, por lo tanto las variedades de cannabis medicinal con un porcentaje más alto en CBD serán las que más utilidad puedan tener en este campo. Aunque el efecto sedante es muy importante, el CBD tiene más efectos positivos que pueden ser usados en terapias y tratamientos contra algunas enfermedades. Por ejemplo, puede servir como relajante muscular, antidepresivo, control del estrés, propiedades anticonvulsivas y muchas más cualidades que iremos mencionando. En SLC tenemos en catálogo las semillas de marihuana medicinales con el porcentaje de CBD más alto del mercado.</p>
                                   ...
                                   <div class="panel panel-default">
                                    ...
                                    <p>Esto es sólo un ejemplo ya que se han realizado múltitud de estudios sobre los efectos del cannabis terapéutico en pacientes que sufren algún tipo de convulsión debido a su enfermedad. Recuerda consultar un médico especialista antes de usar nuestros productos relacionados con el cannabis medicinal, como nuestras semillas, métodos de extracción o aceites CBD.</p>
                                    <br/>
 ...
 <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne4">
                                              ...
                                              <a data-toggle="collapse" data-parent="#accordion2" href="#collapseOne5" aria-expanded="true" aria-controls="collapseOne5" class="link-collapse"  onclick="toggledisplayarrow(5);">
                                                  <h4 class="panel-title">   ¿SATIVA O INDICA? ¿QUÉ VARIEDAD DE CANNABIS MEDICINAL PARA MI ENFERMEDAD?  <i id="arrow-down5" class="fa fa-arrow-down" aria-hidden="true"></i>
                                    ...
                                    <div id="collapseOne5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne4" aria-expanded="true" style="">
                                         <div class="panel-body">
                                    <p>La marihuana contiene diversos cannabinoides y sus efectos irán en función de las proporciones de los mismos. Recuerda que dichas proporciones las podrás encontrar en las fichas de nuestras semillas de marihuana en el apartado de "Ver descripción". Los efectos terapéuticos van ligados a un elevado nivel de CBD, mientras que los efectos más psicoactivos son producidos por los niveles elevados de THC, los dos cannabinoides principales de la marihuana. En definitiva, una variedad medicinal tiene que tener un elevado nivel de CBD.</p>
                                    ...
                                    <p>Por su parte, las variedades de semillas indicas son más relajantes y pueden causar somnolencia. Esto puede resultar positivo para evitar la ansiedad que puede provocar el consumo de variedades sativas. Además, también pueden ayudar con el insomnio o los dolores musculares. De todos modos, la mayoría de las cepas o semillas de marihuana combinan genes de sativa y de indica, lo cual puede resultar beneficioso para el consumidor ya que suelen aunar lo mejor de cada genética. </p>
                                          </div><div class="separador">
                                          </div>
                                       </div></div>
                                        <br/>
                                  ...
                                  <div class="panel-heading category-head" role="tab" id="headingOne5">
                                   ...
                                   <div class="button-category"><input class="main-color category-show" type="submit" onClick="window.location.href='https://www.semillaslowcost.com/13-semillas-feminizadas'" value="VER CATÁLOGO SEMILLAS"></div>
                                    <div id="collapseOne6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne5" aria-expanded="true" style="">
                                         <div class="panel-body">
                                    <p> En Semillas Low Cost ponemos a disposición de nuestros clientes semillas de marihuana medicinales baratas de las mejores variedades indicas de todo el mundo y de la mejor calidad. Recordemos que las variedades de semillas Indicas tienen un CBD alto y son las que su principal característica es su efecto narcótico y relajante. En nuestra web podrás encontrar las semillas de cannabis indico de los mejores y más prestigiosos bancos del mundo. Por ejemplo disponemos en stock de semillas de famosas variedades indicas como la BlueBerry del banco Dutch Pasion, la Matanus-k de Gea Seeds, Strawberry Amnesia de Dinafem, Prozac de Medical Seeds etc... </p>
                                    <p>Nuestros expertos en semillas han realizado una selección de las mejores variedades de semillas de marihuana indicas de uso médico de los bancos de semillas más importantes del planeta y con CBD altos:
 </p>
                                          </div>
                                       </div></div>
                                        <br/>
         ...
         <ul class="tree dynamized" style="display: block;">
            ...
            <li>
               ...
               <ul id="menu-93" style="display: none;">
                  <li> <a href="https://www.semillaslowcost.com/130-cultibox" title="Cultibox"> Cultibox </a></li>
                  <li> <a href="https://www.semillaslowcost.com/131-mammoth" title="Mammoth"> Mammoth </a></li>
                  <li class="last"> <a href="https://www.semillaslowcost.com/199-grow-tent" title="Grow Tent"> Grow Tent </a></li>
               </ul>
            </li>
            <li>
            ...
            <li>
               <span class="grower CLOSE"  onclick="toggleMenu('menu-96')"> </span><a href="https://www.semillaslowcost.com/96-fertilizantes-y-preventivos" title="FERTILIZANTES Y PREVENTIVOS"> FERTILIZANTES Y PREVENTIVOS </a>
               <ul id="menu-96" style="display: none;">
            ...
            <li>
               <span class="grower CLOSE" onclick="toggleMenu('menu-98')"> </span><a href="https://www.semillaslowcost.com/98-kits" title="KITS"> KITS </a>
            ...
            <li>
               <span class="grower CLOSE"  onclick="toggleMenu('menu-104')"> </span><a href="https://www.semillaslowcost.com/104-macetas-y-bandejas" title="MACETAS Y BANDEJAS"> MACETAS Y BANDEJAS </a>
               <ul id="menu-104" style="display: none;">
                  <li> <a href="https://www.semillaslowcost.com/205-macetas" title="Macetas"> Macetas </a></li>
                  <li class="last"> <a href="https://www.semillaslowcost.com/206-bandejas" title="Bandejas"> Bandejas </a></li>
               </ul>
            </li>
            <li>
               <span class="grower CLOSE"  onclick="toggleMenu('menu-107')"> </span><a href="https://www.semillaslowcost.com/107-tratamiento-de-olores" title="TRATAMIENTO DE OLORES"> TRATAMIENTO DE OLORES </a>
               <ul id="menu-107" style="display: none;">
                  <li> <a href="https://www.semillaslowcost.com/186-filtros-antiolor" title="Filtros Antiolor"> Filtros Antiolor </a></li>
                  <li> <a href="https://www.semillaslowcost.com/187-ozonizadores" title="Ozonizadores"> Ozonizadores </a></li>
                  <li class="last"> <a href="https://www.semillaslowcost.com/213-ambientadores" title="Ambientadores"> Ambientadores </a></li>
               </ul>
            </li>
            ...
            <li class="last">
               ...
               <ul id="menu-229" style="display: none;">
                  ...
                  <li> <a href="https://www.semillaslowcost.com/234-mosca-del-suelo" title="Mosca del Suelo"> Mosca del Suelo </a></li>
                  <li> <a href="https://www.semillaslowcost.com/235-orugas" title="Orugas"> Orugas </a></li>
                  <li> <a href="https://www.semillaslowcost.com/236-pulgon" title="Pulgon"> Pulgon </a></li>
