...
Después de varios proyectos en los que se necesitaba mostrar productos Prestashop en el blog Wordpress, he creado una primera versión en la que podemos mostrar productos (seleccionando sus IDs o aleatoriamente de una categoría) de una tienda online Prestashop. 

¡Y es 100% gratuita!

En Prestashop hay muchas combinaciones de producto, de precios, de ofertas, etc. Y en esta primera versión se obtiene el precio base, también muestra precios con oferta, y solo muestra productos activos y que tienen stock, también se ha probado con productos combinados y no se han encontrado incidencias.

En cuanto a las ofertas, se muestran las ofertas propias de los productos, no a categorias o a la tienda completa, espero poder mejorar esta parte para próximas versiones.

Se ha añadido la posibilidad de indicar si queremos que nunca se muestren las ofertas.

El módulo también permite indicar el idioma en el que queremos mostrar los productos y si queremos que los enlaces sean noFollow.
...
5. Rellenamos los datos y probamos que la conexión con la tienda se hace correctamente.
6. Introducimos productos en nuestras entradas con los shortcodes y el Widget:
[imacPrestashop_categorias]
[imacPrestashop_categorias cant_productos="6" categoria="1" idioma="1"] 
y
[imacPrestashop_productos]
[imacPrestashop_productos productos="1,2,3,4,5,6" idioma="1"]
...
2. Pantallazo de shortcode de 1 categoría
3. Pantallazo de shortcode de 5 productos definidos por su ID
4. Pantallazo del Widget
5. Prueba con prestashop 1.7
