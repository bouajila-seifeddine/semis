...
<?php if ( post_password_required() ): ?>
     <p class="nopassword"><?php esc_html_e( 'This post is password protected. Enter the password to view and post comments.' , 'infowazz' ); ?></p>
...
?>
			<div class="navigation mt-coment-nav mt-comment-nav-top">
				<div class="nav-previous"><?php previous_comments_link( wp_kses(__( '<span class="meta-nav">&larr;</span> Older Comments', 'infowazz' ), $infowazz_allowed_html_array )); ?></div>
				<div class="nav-next"><?php next_comments_link( wp_kses(__( 'Newer Comments <span class="meta-nav">&rarr;</span>', 'infowazz' ) , $infowazz_allowed_html_array )); ?></div>
			</div> <!-- .navigation -->
...
<?php endif; // check for comment navigation ?>
			...
			<ol class="commentlist">
				<?php
					wp_list_comments( array( 'callback' => 'infowazz_comment' ) );
				?>
			</ol>
...
$fields =  array(
 ...
 $defaults = array(
	...
	'logged_in_as'         => '<p class="logged-in-as">' . sprintf( wp_kses(__( 'Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account" class="mt-theme-text">Log out?</a>', 'infowazz' ), array(
    'a' => array(
        'href' => array(),
        'title' => array()
    ),
	...
	'id_form'              => 'commentform',
	'id_submit'            => 'submit',
	'title_reply'          => esc_html__( 'Leave a Comment', 'infowazz' ),
	'title_reply_to'       => esc_html__( 'Leave a Reply to %s', 'infowazz' ),
	'cancel_reply_link'    => esc_html__( 'Cancel reply', 'infowazz' ),
	'label_submit'         => esc_html__( 'Submit Comment', 'infowazz' ),
