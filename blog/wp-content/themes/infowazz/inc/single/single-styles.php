...
<div class="post-content-wrap mt-content-container">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 pull-right <?php echo sanitize_html_class($fs); ?> sidebar theiaStickySidebar" itemscope="itemscope" itemtype="https://schema.org/WPSideBar">
    ...
    <div class="post-media-wrap">
      <div class="container">
      	<div class="single-media-top mt-radius single-image-gradient">
      		<div class="mt-post-image"><div class="mt-post-image-background" style="background-image:url('<?php echo get_the_post_thumbnail_url(get_the_ID(),'magazin_5'); ?>');"></div><img class="lazy" alt="portada artículo marihuana" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="<?php echo get_the_post_thumbnail_url(get_the_ID(),'large'); ?>" width="550" height="550" /></div>
    ...
    <div class="post-media-wrap">
      <div class="single-media">
        <div class="single-media-wrap">
          <div class="mt-post-image"><div class="mt-post-image-background" style="background-image:url('<?php echo get_the_post_thumbnail_url(get_the_ID(),'magazin_5'); ?>');"></div><img class="lazy"  alt="portada artículo marihuana" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="<?php echo get_the_post_thumbnail_url(get_the_ID(),'full'); ?>" width="550" height="550" /></div>
