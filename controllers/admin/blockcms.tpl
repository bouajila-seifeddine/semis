...
{else}
	...
	<section class="footer-block col-xs-12 col-sm-3" id="block_various_links_footer">
		...
		<ul class="toggle-footer">
			...
			<!-- link formulario tiendas -->

			{if $lang_iso=="es"}
				<li class="item">
					<a href="/es/cf/hazte-distribuidor-1" title="form">Alta distribuidores</a>
				</li>
				<li class="item"> <a href="https://geaseeds.com/timeline/es/" title="TIMELINE Y OBJETIVOS CUMPLIDOS">TIMELINE GEASEEDS</a></li>

			{elseif $lang_iso=="fr"}
				<li class="item">
					<a href="/fr/cf/hazte-distribuidor-1" title="form">Formulaire d'inscription</a>
				</li>
				{elseif $lang_iso=="en"}
				<li class="item">
					<a href="/en/cf/hazte-distribuidor-1" title="form">Registration distributors</a>
				</li>
				{elseif $lang_iso=="cs"}
				<li class="item">
					<a href="/cs/cf/hazte-distribuidor-1" title="form">REGISTRAČNÍ FOLMURÁŘ</a>
				</li>

				 {elseif $lang_iso=="it"}
				<li class="item">
					<a href="/it/cf/hazte-distribuidor-1" title="form">DIVENTA DISTRIBUTORE</a>
				</li>

				{elseif $lang_iso=="pt"}
				<li class="item">
					<a href="/pt/cf/hazte-distribuidor-1" title="form">SEJA UM DISTRIBUIDOR</a>
				</li>

				 {elseif $lang_iso=="de"}
				<li class="item">
					<a href="/de/cf/hazte-distribuidor-1" title="form">VERTRIEBSPARTNER WERDEN</a>
				</li>
	...
	<section class="bottom-footer col-xs-12">
		<div>
			<!-- &copy; 2014 {l s='[1]Ecommerce software by %s[/1]' mod='blockcms' sprintf=['PrestaShop™'] tags=['<a class="_blank" href="http://www..com">']} -->
		</div>
	</section>
	{/if}
	<!-- /MODULE Block footer -->
