...
if (isset($cmtx_categoria)) {
	define('CMTX_CATEGORIA', $cmtx_categoria);
}
if (isset($cmtx_categoria2)) {
	define('CMTX_CATEGORIA2', $cmtx_categoria2);
}
if (isset($cmtx_categoria3)) {
	define('CMTX_CATEGORIA3', $cmtx_categoria3);
}
