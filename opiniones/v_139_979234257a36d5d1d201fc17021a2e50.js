...
function getStorageAvailable() {
            ...
            if (f && !r) {
                if (s = Y.exec(e))
                    ...
                    if (w = x = y, C = t, k = 9 === p && e, 1 === p && "object" !== t.nodeName.toLowerCase()) {
                        ...
                        C = K.test(e) && ue(t.parentNode) || t, k = g.join(",")
                    }
                    if (k) try {
            ...
            return function(e, t, i, r) {
                ...
                if (!r && 1 === p.length) {
                    ...
                    for (s = U.needsContext.test(e) ? 0 : l.length; s-- && (c = l[s], !o.relative[u = c.type]);)
                        if ((d = o.find[u]) && (r = d(c.matches[0].replace(Z, ee), K.test(l[0].type) && ue(t.parentNode) || t))) {
                            if (l.splice(s, 1), !(e = r.length && fe(l))) return A.apply(i, r), i;
                            break
                        }
                }
                return a(e, p)(r, t, !f, i, K.test(e) && ue(t.parentNode) || t), i
            }(e.replace(F, "$1"), t, i, r)
        }
        ...
        add: function(e, t, n, o, i) {
            ...
            if (v) {
                for (n.handler && (n = (l = n).handler, i = l.selector), n.guid || (n.guid = p.guid++), (a = v.events) || (a = v.events = {}), (u = v.handle) || ((u = v.handle = function(e) {
                    ...
                    }).elem = e), s = (t = (t || "").match(_) || [""]).length; s--;) h = g = (r = K.exec(t[s]) || [])[1], m = (r[2] || "").split(".").sort(), h && (c = p.event.special[h] || {}, h = (i ? c.delegateType : c.bindType) || h, c = p.event.special[h] || {}, d = p.extend({
                    type: h,
                    origType: g,
                    data: o,
                    handler: n,
    ...
    p.param = function(e, t) {
        ...
        return !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && Yt() || function() {
            try {
    ...
    p.ajaxSetup({
        ...
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = p.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Gt, "$1" + i) : !1 !== t.jsonp && (t.url += ($t.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
            ...
            e[i] = r, t[i] && (t.jsonpCallback = n.jsonpCallback, Kt.push(i)), a && p.isFunction(r) && r(a[0]), a = r = void 0
        }), "script") : void 0
...
$(document).ready(function() {
    highdpiInit(), responsiveResize(), $(window).resize(responsiveResize), navigator.userAgent.match(/Android/i) && (document.querySelector('meta[name="viewport"]').setAttribute("content", "initial-scale=1.0,maximum-scale=1.0,user-scalable=0,width=device-width,height=device-height"), window.scrollTo(0, 1)), "undefined" != typeof quickView && quickView && quick_view(), dropDown(), "undefined" == typeof page_name || in_array(page_name, ["index", "product"]) || ($(document).on("change", ".selectProductSort", function(e) {
        ...
        16 <= e.offsetX && e.offsetX <= 39 && 16 <= e.offsetY && e.offsetY <= 34 && $(this).fadeOut()
    })
});
...
function displayNotification_AC() {
    var e = '<div id="deluxe_adult_content" style="background-color:' + user_options_AC.dlxColor + "; opacity:" + user_options_AC.dlxOpacity + '">';
    e += '<div id="adultcontent">', e += '<div id="center">', e += urldecode_AC(nl2br_AC(user_options_AC.messageContent, !0)), e += '<div id="buttons">', e += '<p style="text-align:center" id="ok">', e += '<a href="#" id="adultcontentOK" onClick=\'JavaScript:setCookie_AC("' + user_options_AC.cookieName + "\",365);'>" + user_options_AC.okText + "</a>", e += "</p>", e += '<p style="text-align:center" id="warning">', e += '<a id="adultcontentnotOK" href="' + user_options_AC.redirectLink + "\" onClick='JavaScript:killCookies_AC();'>" + user_options_AC.notOkText + "</a>", e += "</p>", e += "</div>", e += "</div", e += "</div", e += "</div>", jQuery("body").prepend(e)
}
...
function setCookie_AC(e, t) {
    ...
    o && (o.innerHTML = "", null != document.getElementById("deluxe_adult_content") && (document.getElementById("deluxe_adult_content").style.display = "none"))
}
...
function checkCookie_AC() {
	        var cookie_grow= getCookie('_gat_UA-70811397-1');
	        	if(cookie_grow == null){
